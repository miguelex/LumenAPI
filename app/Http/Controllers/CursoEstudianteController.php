...
class CursoEstudianteController extends Controller {
	...
	public function index($curso_id) {
		...
		return $this->crearRespuestaErronea('No se puede encontrar el curso espcificado' ,404);
	}
	...
	public function store($curso_id, $estudiante_id) {
		...
		if($curso)
		{
			...
			return $this->crearRespuestaErronea('No se puede encontrar un estudiante con el id dado', 404);
		}
		return $this->crearRespuestaErronea('No se puede encontrar un curso con el id dado', 404);
	}
	...
	public function destroy($curso_id, $estudiante_id) {
		...
		if($curso)
		{
			...
			return $this->crearRespuestaErronea('No existe un estudiante con el id dado en este curso', 404);
		}
		return $this->crearRespuestaErronea('No se puede encontrar un curso con el id dado', 404);
	}
}