...
class ProfesorCursoController extends Controller {
	...
	public function index($profesor_id) {
		...
		return $this->crearRespuestaErronea('No se puede encontrar el profesor espcificado' ,404);
	}
	...
	public function update(Request $request, $profesor_id, $curso_id) {
		...
		if($profesor)
		{
			...
			return $this->crearRespuestaErronea('No existe un curso con el id dado', 404);
		}
		return $this->crearRespuestaErronea('No existe un profesor con el id dado', 404);
	}
	...
	public function destroy($profesor_id, $curso_id) {
		...
		if($profesor)
		{
			...
			return $this->crearRespuestaErronea('No existe un curso con este id asociado a este profesor', 404);
		}
		return $this->crearRespuestaErronea('No existe un profesor con el id dado', 404);
	}
